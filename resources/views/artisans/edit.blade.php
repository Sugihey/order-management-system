<x-layout.scraft>
    <x-slot name="title">職人情報編集</x-slot>

    <div class="py-8">
        <x-breads scheme="scraft" :nodes="[['title'=>'職人一覧','route'=>'artisans.index']]" current="職人情報編集"/>
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6">職人情報編集</h1>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-form.input 
                            ...
                            name="phone_no" 
                            type="tel" 
                            :value="old('phone_no', $artisan->phone_no)"
                            required
                        />
                        @error('phone_no')
                            <x-form.error>{{ $message }}</x-form.error>
